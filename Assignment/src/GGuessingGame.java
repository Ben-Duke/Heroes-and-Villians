...
public class GGuessingGame {
	...
	private void initialize() {
		...
		GuessingGamePanel.add(button);
		
		JButton button_1 = new JButton("2");
		button_1.setBounds(105, 39, 75, 49);
		GuessingGamePanel.add(button_1);
		
		JButton button_2 = new JButton("3");
		button_2.setBounds(192, 39, 75, 49);
		GuessingGamePanel.add(button_2);
		
		JButton button_3 = new JButton("4");
		button_3.setBounds(279, 39, 75, 49);
		GuessingGamePanel.add(button_3);
		
		JButton button_4 = new JButton("5");
		button_4.setBounds(363, 39, 75, 49);
		GuessingGamePanel.add(button_4);
		
		JButton button_5 = new JButton("6");
		button_5.setBounds(18, 105, 75, 49);
		GuessingGamePanel.add(button_5);
		
		JButton button_6 = new JButton("7");
		button_6.setBounds(105, 105, 75, 49);
		GuessingGamePanel.add(button_6);
		
		JButton button_7 = new JButton("8");
		button_7.setBounds(192, 104, 75, 50);
		GuessingGamePanel.add(button_7);
		
		JButton button_8 = new JButton("9");
		button_8.setBounds(279, 105, 75, 49);
		GuessingGamePanel.add(button_8);
		
		JButton button_9 = new JButton("10");
		button_9.setBounds(363, 105, 75, 49);
		GuessingGamePanel.add(button_9);
		
		JPanel GuessingGamePanel_1 = new JPanel();
		GuessingGamePanel_1.setBounds(92, 92, -58, -24);
		GuessingGamePanel.add(GuessingGamePanel_1);
	}
}
